...
############################main##############################
fileList=['message.xml','TestUnit.xml','vcssys.xml','vcsidsync.xml','myTester.py','myDir.py','killNProcess.py']
        ...
        #result = auth_user()
            ...
            while True:
                ...
                if select == 'y':
                    ...
                    s.sendall('exit')
                    sys.exit('transfer completed, exit')
